...
function ECBlocks(e, t, n) {
    this.ecCodewordsPerBlock = e, this.ecBlocks = n ? [t, n] : Array(t), this.__defineGetter__("ECCodewordsPerBlock", function() {
...
function Version(e, t, n, i, r, o) {
    for (this.versionNumber = e, this.alignmentPatternCenters = t, this.ecBlocks = [n, i, r, o], e = 0, t = n.ECCodewordsPerBlock, n = n.getECBlocks(), i = 0; i < n.length; i++) r = n[i], e += r.Count * (r.DataCodewords + t);
    this.totalCodewords = e, this.__defineGetter__("VersionNumber", function() {
        ...
        return t.setRegion(6, 9, 1, e - 17), t.setRegion(9, 6, e - 17, 1), 6 < this.versionNumber && (t.setRegion(e - 11, 0, 3, 6), t.setRegion(0, e - 11, 6, 3)), t
...
function PerspectiveTransform(e, t, n, i, r, o, s, a, h) {
    this.a11 = e, this.a12 = i, this.a13 = s, this.a21 = t, this.a22 = r, this.a23 = a, this.a31 = n, this.a32 = o, this.a33 = h, this.transformPoints1 = function(e) {
        for (var t = e.length, n = this.a11, i = this.a12, r = this.a13, o = this.a21, s = this.a22, a = this.a23, h = this.a31, c = this.a32, l = this.a33, f = 0; t > f; f += 2) {
            var d = e[f],
                w = e[f + 1],
                u = r * d + a * w + l;
        ...
        for (var n = e.length, i = 0; n > i; i++) {
            ...
            e[i] = (this.a11 * r + this.a21 * o + this.a31) / s, t[i] = (this.a12 * r + this.a22 * o + this.a32) / s
        }
...
function Detector(e) {
    this.image = e, this.resultPointCallback = null, this.sizeOfBlackWhiteBlackRun = function(e, t, n, i) {
        ...
        for (var s = Math.abs(n - e), a = Math.abs(i - t), h = -s >> 1, c = i > t ? 1 : -1, l = n > e ? 1 : -1, f = 0, d = e, o = t; d != n; d += l) {
            var w = r ? o : d,
                u = r ? d : o;
            if (1 == f ? this.image[w + u * qrcode.width] && f++ : this.image[w + u * qrcode.width] || f++, 3 == f) return i = d - e, t = o - t, Math.sqrt(i * i + t * t);
            if (h += a, h > 0) {
                if (o == i) break;
                o += c, h -= s
            }
        ...
        var r = this.sizeOfBlackWhiteBlackRun(e, t, n, i),
            o = 1;
        return n = e - (n - e), 0 > n ? (o = e / (e - n), n = 0) : n >= qrcode.width && (o = (qrcode.width - 1 - e) / (n - e), n = qrcode.width - 1), i = Math.floor(t - (i - t) * o), o = 1, 0 > i ? (o = t / (t - i), i = 0) : i >= qrcode.height && (o = (qrcode.height - 1 - t) / (i - t), i = qrcode.height - 1), n = Math.floor(e + (n - e) * o), r += this.sizeOfBlackWhiteBlackRun(e, t, n, i), r - 1
        ...
        switch (t = Math.round(this.distance(e, t) / i), e = Math.round(this.distance(e, n) / i), e = (t + e >> 1) + 7, 3 & e) {
            case 0:
                e++;
                break;
            case 2:
        ...
        if (i = Math.max(0, t - r), t = Math.min(qrcode.width - 1, t + r), 3 * e > t - i) throw "Error";
        var o = Math.max(0, n - r);
        return n = Math.min(qrcode.height - 1, n + r), new AlignmentPatternFinder(this.image, i, o, t - i, n - o, e, this.resultPointCallback).find()
    }, this.createTransform = function(e, t, n, i, r) {
        r -= 3.5;
        var o, s, a;
        return null != i ? (o = i.X, i = i.Y, s = a = r - 3) : (o = t.X - e.X + n.X, i = t.Y - e.Y + n.Y, s = a = r), PerspectiveTransform.quadrilateralToQuadrilateral(3.5, 3.5, r, 3.5, s, a, 3.5, r, e.X, e.Y, t.X, t.Y, o, i, n.X, n.Y)
        ...
        if (0 < o.AlignmentPatternCenters.length)
            for (s = 1 - 3 / s, o = Math.floor(t.X + s * (n.X - t.X + e.X - t.X)), s = Math.floor(t.Y + s * (n.Y - t.Y + e.Y - t.Y));;) {
                a = this.findAlignmentInRegion(i, o, s, 4);
                break
            }
        return i = this.createTransform(t, n, e, a, r), r = this.sampleGrid(this.image, i, r), new DetectorResult(r, null == a ? [e, t, n] : [e, t, n, a])
...
function BitMatrix(e, t) {
    ...
    var n = e >> 5;
    for (0 != (31 & e) && n++, this.rowSize = n, this.bits = Array(n * t), n = 0; n < this.bits.length; n++) this.bits[n] = 0;
    this.__defineGetter__("Width", function() {
        ...
        if (n = e + n, i = t + i, i > this.height || n > this.width) throw "The region must fit inside the matrix";
        for (; i > t; t++)
            for (var r = t * this.rowSize, o = e; n > o; o++) this.bits[r + (o >> 5)] |= 1 << (31 & o)
    }
}
...
function BitMatrixParser(e) {
    ...
    this.bitMatrix = e, this.parsedFormatInfo = this.parsedVersion = null, this.copyBit = function(e, t, n) {
        ...
        for (e = this.copyBit(7, 8, e), e = this.copyBit(8, 8, e), e = this.copyBit(8, 7, e), t = 5; t >= 0; t--) e = this.copyBit(8, t, e);
        ...
        for (var n = this.bitMatrix.Dimension, e = 0, i = n - 8, t = n - 1; t >= i; t--) e = this.copyBit(t, 8, e);
        ...
        if (this.parsedVersion = Version.decodeVersionInformation(t), null != this.parsedVersion && this.parsedVersion.DimensionForVersion == e) return this.parsedVersion;
        for (t = 0, r = 5; r >= 0; r--)
        ...
        for (var n = t.buildFunctionPattern(), i = !0, r = Array(t.TotalCodewords), o = 0, s = 0, a = 0, h = e - 1; h > 0; h -= 2) {
            6 == h && h--;
            for (var c = 0; e > c; c++)
                for (var l = i ? e - 1 - c : c, f = 0; 2 > f; f++) n.get_Renamed(h - f, l) || (a++, s <<= 1, this.bitMatrix.get_Renamed(h - f, l) && (s |= 1), 8 == a && (r[o++] = s, s = a = 0));
            i ^= 1
        }
...
function ReedSolomonDecoder(e) {
    this.field = e, this.decode = function(e, t) {
        for (var n = new GF256Poly(this.field, e), i = Array(t), r = 0; r < i.length; r++) i[r] = 0;
        for (var o = !0, r = 0; t > r; r++) {
            var s = n.evaluateAt(this.field.exp(r));
            i[i.length - 1 - r] = s, 0 != s && (o = !1)
        }
        if (!o)
            for (r = new GF256Poly(this.field, i), n = this.runEuclideanAlgorithm(this.field.buildMonomial(t, 1), r, t), r = n[1], n = this.findErrorLocations(n[0]), i = this.findErrorMagnitudes(r, n, !1), r = 0; r < n.length; r++) {
                if (o = e.length - 1 - this.field.log(n[r]), 0 > o) throw "ReedSolomonException Bad error location";
        ...
        for (var i = this.field.One, r = this.field.Zero, o = this.field.Zero, s = this.field.One; t.Degree >= Math.floor(n / 2);) {
            var a = e,
                h = i,
                c = o;
            if (e = t, i = r, o = s, e.Zero) throw "r_{i-1} was zero";
            for (t = a, s = this.field.Zero, r = e.getCoefficient(e.Degree), r = this.field.inverse(r); t.Degree >= e.Degree && !t.Zero;) {
            ...
            r = s.multiply1(i).addOrSubtract(h), s = s.multiply1(o).addOrSubtract(c)
        }
        if (n = s.getCoefficient(0), 0 == n) throw "ReedSolomonException sigmaTilde(0) was zero";
        return n = this.field.inverse(n), e = s.multiply2(n), n = t.multiply2(n), [e, n]
    }, this.findErrorLocations = function(e) {
        var t = e.Degree;
        if (1 == t) return Array(e.getCoefficient(1));
        for (var n = Array(t), i = 0, r = 1; 256 > r && t > i; r++) 0 == e.evaluateAt(r) && (n[i] = this.field.inverse(r), i++);
        ...
        for (var i = t.length, r = Array(i), o = 0; i > o; o++) {
            for (var s = this.field.inverse(t[o]), a = 1, h = 0; i > h; h++) o != h && (a = this.field.multiply(a, GF256.addOrSubtract(1, this.field.multiply(t[h], s))));
            r[o] = this.field.multiply(e.evaluateAt(s), this.field.inverse(a)), n && (r[o] = this.field.multiply(r[o], s))
        }
        return r
    }
}
...
function GF256Poly(e, t) {
    ...
    if (n > 1 && 0 == t[0]) {
        ...
        if (i == n) this.coefficients = e.Zero.coefficients;
            ...
            for (this.coefficients = Array(n - i), n = 0; n < this.coefficients.length; n++) this.coefficients[n] = 0;
            for (n = 0; n < this.coefficients.length; n++) this.coefficients[n] = t[i + n]
        }
    ...
    this.__defineGetter__("Zero", function() {
        ...
        if (1 == e) {
            for (var n = e = 0; t > n; n++) e = GF256.addOrSubtract(e, this.coefficients[n]);
            return e
        }
        for (var i = this.coefficients[0], n = 1; t > n; n++) i = GF256.addOrSubtract(this.field.multiply(e, i), this.coefficients[n]);
        return i
        ...
        for (var i = Array(t.length), r = t.length - n.length, o = 0; r > o; o++) i[o] = t[o];
        ...
        for (var i = e.length, r = Array(n + i - 1), o = 0; n > o; o++)
            for (var s = t[o], a = 0; i > a; a++) r[o + a] = GF256.addOrSubtract(r[o + a], this.field.multiply(s, e[a]));
        return new GF256Poly(this.field, r)
    }, this.multiply2 = function(e) {
        if (0 == e) return this.field.Zero;
        if (1 == e) return this;
        for (var t = this.coefficients.length, n = Array(t), i = 0; t > i; i++) n[i] = this.field.multiply(this.coefficients[i], e);
        ...
        for (var n = this.coefficients.length, i = Array(n + e), r = 0; r < i.length; r++) i[r] = 0;
        for (r = 0; n > r; r++) i[r] = this.field.multiply(this.coefficients[r], t);
        return new GF256Poly(this.field, i)
    }, this.divide = function(e) {
        if (this.field != e.field) throw "GF256Polys do not have same GF256 field";
        if (e.Zero) throw "Divide by 0";
        for (var t = this.field.Zero, n = this, i = e.getCoefficient(e.Degree), i = this.field.inverse(i); n.Degree >= e.Degree && !n.Zero;) var r = n.Degree - e.Degree,
...
function GF256(e) {
    ...
    e = Array(1), e[0] = 0, this.zero = new GF256Poly(this, Array(e)), e = Array(1), e[0] = 1, this.one = new GF256Poly(this, Array(e)), this.__defineGetter__("Zero", function() {
        return this.zero
...
function FinderPattern(e, t, n) {
    this.x = e, this.y = t, this.count = 1, this.estimatedModuleSize = n, this.__defineGetter__("EstimatedModuleSize", function() {
        ...
        return Math.abs(t - this.y) <= e && Math.abs(n - this.x) <= e ? (e = Math.abs(e - this.estimatedModuleSize), 1 >= e || 1 >= e / this.estimatedModuleSize) : !1
    }
}
...
function FinderPatternFinder() {
    this.image = null, this.possibleCenters = [], this.hasSkipped = !1, this.crossCheckStateCount = [0, 0, 0, 0, 0], this.resultPointCallback = null, this.__defineGetter__("CrossCheckStateCount", function() {
        ...
        return 7 > t ? !1 : (t = Math.floor((t << INTEGER_MATH_SHIFT) / 7), n = Math.floor(t / 2), Math.abs(t - (e[0] << INTEGER_MATH_SHIFT)) < n && Math.abs(t - (e[1] << INTEGER_MATH_SHIFT)) < n && Math.abs(3 * t - (e[2] << INTEGER_MATH_SHIFT)) < 3 * n && Math.abs(t - (e[3] << INTEGER_MATH_SHIFT)) < n && Math.abs(t - (e[4] << INTEGER_MATH_SHIFT)) < n)
    }, this.centerFromEnd = function(e, t) {
        return t - e[4] - e[3] - e[2] / 2
    }, this.crossCheckVertical = function(e, t, n, i) {
        for (var r = this.image, o = qrcode.height, s = this.CrossCheckStateCount, a = e; a >= 0 && r[t + a * qrcode.width];) s[2]++, a--;
        if (0 > a) return 0 / 0;
        ...
        return s[4] >= n || 5 * Math.abs(s[0] + s[1] + s[2] + s[3] + s[4] - i) >= 2 * i ? 0 / 0 : this.foundPatternCross(s) ? this.centerFromEnd(s, a) : 0 / 0
    }, this.crossCheckHorizontal = function(e, t, n, i) {
        for (var r = this.image, o = qrcode.width, s = this.CrossCheckStateCount, a = e; a >= 0 && r[a + t * qrcode.width];) s[2]++, a--;
        if (0 > a) return 0 / 0;
        ...
        return s[4] >= n || 5 * Math.abs(s[0] + s[1] + s[2] + s[3] + s[4] - i) >= i ? 0 / 0 : this.foundPatternCross(s) ? this.centerFromEnd(s, a) : 0 / 0
    }, this.handlePossibleCenter = function(e, t, n) {
        var i = e[0] + e[1] + e[2] + e[3] + e[4];
        if (n = this.centerFromEnd(e, n), t = this.crossCheckVertical(t, Math.floor(n), e[2], i), !isNaN(t) && (n = this.crossCheckHorizontal(Math.floor(n), Math.floor(t), e[2], i), !isNaN(n))) {
            e = i / 7;
            ...
            return i || (n = new FinderPattern(n, t, e), this.possibleCenters.push(n), null != this.resultPointCallback && this.resultPointCallback.foundPossibleResultPoint(n)), !0
        }
        return !1
        ...
        if (e > 3) {
            for (var t = 0, n = 0; e > n; n++) t += this.possibleCenters[n].EstimatedModuleSize;
            for (e = t / e, n = 0; n < this.possibleCenters.length && 3 < this.possibleCenters.length; n++) Math.abs(this.possibleCenters[n].EstimatedModuleSize - e) > .2 * e && (this.possibleCenters.remove(n), n--)
        }
        ...
        if (3 > e) return !1;
        for (var e = t / n, o = 0, i = 0; n > i; i++) r = this.possibleCenters[i], o += Math.abs(r.EstimatedModuleSize - e);
        return .05 * t >= o
        ...
        for (var r = !1, o = Array(5), s = i - 1; t > s && !r; s += i) {
            ...
            for (var a = o[4] = 0, h = 0; n > h; h++)
                ...
                if (4 == a)
                    if (this.foundPatternCross(o)) {
                        if (a = this.handlePossibleCenter(o, s, h)) i = 2, this.hasSkipped ? r = this.haveMultiplyConfirmedCenters() : (a = this.findRowSkip(), a > o[2] && (s += a - o[2] - i, h = n - 1));
                        else {
                            do h++; while (n > h && !e[h + s * qrcode.width]);
                            h--
                        }
            ...
            this.foundPatternCross(o) && this.handlePossibleCenter(o, s, n) && (i = o[0], this.hasSkipped && (r = haveMultiplyConfirmedCenters()))
        }
        return e = this.selectBestPatterns(), qrcode.orderBestPatterns(e), new FinderPatternInfo(e)
    }
}
...
function AlignmentPatternFinder(e, t, n, i, r, o, s) {
    this.image = e, this.possibleCenters = [], this.startX = t, this.startY = n, this.width = i, this.height = r, this.moduleSize = o, this.crossCheckStateCount = [0, 0, 0], this.resultPointCallback = s, this.centerFromEnd = function(e, t) {
        return t - e[2] - e[1] / 2
    }, this.foundPatternCross = function(e) {
        ...
        s[0] = 0, s[1] = 0, s[2] = 0;
        for (var a = e; a >= 0 && r[t + a * qrcode.width] && s[1] <= n;) s[1]++, a--;
        if (0 > a || s[1] > n) return 0 / 0;
        for (; a >= 0 && !r[t + a * qrcode.width] && s[0] <= n;) s[0]++, a--;
        if (s[0] > n) return 0 / 0;
        for (a = e + 1; o > a && r[t + a * qrcode.width] && s[1] <= n;) s[1]++, a++;
        if (a == o || s[1] > n) return 0 / 0;
        for (; o > a && !r[t + a * qrcode.width] && s[2] <= n;) s[2]++, a++;
        return s[2] > n || 5 * Math.abs(s[0] + s[1] + s[2] - i) >= 2 * i ? 0 / 0 : this.foundPatternCross(s) ? this.centerFromEnd(s, a) : 0 / 0
    }, this.handlePossibleCenter = function(e, t, n) {
        var i = e[0] + e[1] + e[2];
        if (n = this.centerFromEnd(e, n), t = this.crossCheckVertical(t, Math.floor(n), 2 * e[1], i), !isNaN(t)) {
            e = (e[0] + e[1] + e[2]) / 3;
            for (var i = this.possibleCenters.length, r = 0; i > r; r++)
                if (this.possibleCenters[r].aboutEquals(e, t, n)) return new AlignmentPattern(n, t, e);
            n = new AlignmentPattern(n, t, e), this.possibleCenters.push(n), null != this.resultPointCallback && this.resultPointCallback.foundPossibleResultPoint(n)
        }
        return null
    }, this.find = function() {
        for (var t = this.startX, r = this.height, o = t + i, s = n + (r >> 1), a = [0, 0, 0], h = 0; r > h; h++) {
            ...
            for (var f = 0; o > l;) {
                if (e[l + c * qrcode.width])
                    ...
                    if (this.foundPatternCross(a) && (f = this.handlePossibleCenter(a, c, l), null != f)) return f;
                    a[0] = a[2], a[1] = 1, a[2] = 0, f = 1
                } else a[++f]++;
                else 1 == f && f++, a[f]++;
                l++
            }
            if (this.foundPatternCross(a) && (f = this.handlePossibleCenter(a, c, o), null != f)) return f
        }
...
function QRCodeDataBlockReader(e, t, n) {
    this.blockPointer = 0, this.bitPointer = 7, this.dataLength = 0, this.blocks = e, this.numErrorCorrectionCode = n, 9 >= t ? this.dataLengthMode = 0 : t >= 10 && 26 >= t ? this.dataLengthMode = 1 : t >= 27 && 40 >= t && (this.dataLengthMode = 2), this.getNextBits = function(e) {
        ...
        if (e < this.bitPointer + 1 + 8) {
            ...
            return t = (this.blocks[this.blockPointer] & i) << e - (this.bitPointer + 1), this.blockPointer++, t += this.blocks[this.blockPointer] >> 8 - (e - (this.bitPointer + 1)), this.bitPointer -= e % 8, 0 > this.bitPointer && (this.bitPointer = 8 + this.bitPointer), t
        }
        if (e < this.bitPointer + 1 + 16) {
            for (t = n = i = 0; t < this.bitPointer + 1; t++) i += 1 << t;
            i = (this.blocks[this.blockPointer] & i) << e - (this.bitPointer + 1), this.blockPointer++;
            var r = this.blocks[this.blockPointer] << e - (this.bitPointer + 1 + 8);
            for (this.blockPointer++, t = 0; t < e - (this.bitPointer + 1 + 8); t++) n += 1 << t;
            return n <<= 8 - (e - (this.bitPointer + 1 + 8)), t = i + r + ((this.blocks[this.blockPointer] & n) >> 8 - (e - (this.bitPointer + 1 + 8))), this.bitPointer -= (e - 8) % 8, 0 > this.bitPointer && (this.bitPointer = 8 + this.bitPointer), t
        }
        return 0
        ...
        do
            if (e > 1) {
                var t = this.getNextBits(11),
                    ...
                    n = n + i[r];
                e -= 2
            } else 1 == e && (t = this.getNextBits(6), n += i[t], e -= 1); while (e > 0);
        return n
    }, this.getFigureString = function(e) {
        var t = 0,
            n = "";
        do e >= 3 ? (t = this.getNextBits(10), 100 > t && (n += "0"), 10 > t && (n += "0"), e -= 3) : 2 == e ? (t = this.getNextBits(7), 10 > t && (n += "0"), e -= 2) : 1 == e && (t = this.getNextBits(4), e -= 1), n += t; while (e > 0);
        return n
    }, this.get8bitByteArray = function(e) {
        var t = 0,
            n = [];
        do t = this.getNextBits(8), n.push(t), e--; while (e > 0);
        return n
        ...
        for (var e = [];;) {
            ...
            if (1 != t && 2 != t && 4 != t && 8 != t) throw "Invalid mode: " + t + " in (block:" + this.blockPointer + " bit:" + this.bitPointer + ")";
            if (dataLength = this.getDataLength(t), 1 > dataLength) throw "Invalid data length: " + dataLength;
            switch (t) {
                case 1:
                    for (var t = this.getFigureString(dataLength), n = Array(t.length), i = 0; i < t.length; i++) n[i] = t.charCodeAt(i);
                    e.push(n);
                    break;
                case 2:
                    for (t = this.getRomanAndFigureString(dataLength), n = Array(t.length), i = 0; i < t.length; i++) n[i] = t.charCodeAt(i);
                    e.push(n);
                    break;
                case 4:
...
GridSampler = {
    checkAndNudgePoints: function(e, t) {
        for (var n = qrcode.width, i = qrcode.height, r = !0, o = 0; o < t.Length && r; o += 2) {
            var s = Math.floor(t[o]),
                a = Math.floor(t[o + 1]);
            if (-1 > s || s > n || -1 > a || a > i) throw "Error.checkAndNudgePoints ";
            r = !1, -1 == s ? (t[o] = 0, r = !0) : s == n && (t[o] = n - 1, r = !0), -1 == a ? (t[o + 1] = 0, r = !0) : a == i && (t[o + 1] = i - 1, r = !0)
        }
        for (r = !0, o = t.Length - 2; o >= 0 && r; o -= 2) {
            if (s = Math.floor(t[o]), a = Math.floor(t[o + 1]), -1 > s || s > n || -1 > a || a > i) throw "Error.checkAndNudgePoints ";
            r = !1, -1 == s ? (t[o] = 0, r = !0) : s == n && (t[o] = n - 1, r = !0), -1 == a ? (t[o + 1] = 0, r = !0) : a == i && (t[o + 1] = i - 1, r = !0)
        }
    },
    sampleGrid3: function(e, t, n) {
        for (var i = new BitMatrix(t), r = Array(t << 1), o = 0; t > o; o++) {
            for (var s = r.length, a = o + .5, h = 0; s > h; h += 2) r[h] = (h >> 1) + .5, r[h + 1] = a;
            n.transformPoints1(r), GridSampler.checkAndNudgePoints(e, r);
            try {
                for (h = 0; s > h; h += 2) {
                    var c = 4 * Math.floor(r[h]) + 4 * Math.floor(r[h + 1]) * qrcode.width,
                        l = e[Math.floor(r[h]) + qrcode.width * Math.floor(r[h + 1])];
                    qrcode.imagedata.data[c] = l ? 255 : 0, qrcode.imagedata.data[c + 1] = l ? 255 : 0, qrcode.imagedata.data[c + 2] = 0, qrcode.imagedata.data[c + 3] = 255, l && i.set_Renamed(h >> 1, o)
                }
            } catch (f) {
    ...
    sampleGridx: function(e, t, n, i, r, o, s, a, h, c, l, f, d, w, u, C, E, B) {
        return n = PerspectiveTransform.quadrilateralToQuadrilateral(n, i, r, o, s, a, h, c, l, f, d, w, u, C, E, B), GridSampler.sampleGrid3(e, t, n)
    }
    ...
    for (var t = 4294967295, n = 0, i = 0; i < Version.VERSION_DECODE_INFO.length; i++) {
        ...
        r = FormatInformation.numBitsDiffering(e, r), t > r && (n = i + 7, t = r)
    }
    return 3 >= t ? this.getVersionForNumber(n) : null
}, PerspectiveTransform.quadrilateralToQuadrilateral = function(e, t, n, i, r, o, s, a, h, c, l, f, d, w, u, C) {
    return e = this.quadrilateralToSquare(e, t, n, i, r, o, s, a), this.squareToQuadrilateral(h, c, l, f, d, w, u, C).times(e)
}, PerspectiveTransform.squareToQuadrilateral = function(e, t, n, i, r, o, s, a) {
    return dy2 = a - o, dy3 = t - i + o - a, 0 == dy2 && 0 == dy3 ? new PerspectiveTransform(n - e, r - n, e, i - t, o - i, t, 0, 0, 1) : (dx1 = n - r, dx2 = s - r, dx3 = e - n + r - s, dy1 = i - o, denominator = dx1 * dy2 - dx2 * dy1, a13 = (dx3 * dy2 - dx2 * dy3) / denominator, a23 = (dx1 * dy3 - dx3 * dy1) / denominator, new PerspectiveTransform(n - e + a13 * n, s - e + a23 * s, e, i - t + a13 * i, a - t + a23 * a, t, a13, a23, 1))
}, PerspectiveTransform.quadrilateralToSquare = function(e, t, n, i, r, o, s, a) {
...
DataBlock.getDataBlocks = function(e, t, n) {
    ...
    for (t = n[0].codewords.length, r = n.length - 1; r >= 0 && n[r].codewords.length != t;) r--;
...
}, DataMask.DATA_MASKS = [new DataMask000, new DataMask001, new DataMask010, new DataMask011, new DataMask100, new DataMask101, new DataMask110, new DataMask111], GF256.QR_CODE_FIELD = new GF256(285), GF256.DATA_MATRIX_FIELD = new GF256(301), GF256.addOrSubtract = function(e, t) {
    return e ^ t
    ...
    e = t.readVersion();
    for (var n = t.readFormatInformation().ErrorCorrectionLevel, t = t.readCodewords(), t = DataBlock.getDataBlocks(t, e, n), i = 0, r = 0; r < t.Length; r++) i += t[r].NumDataCodewords;
    ...
    decode: function(e) {
        ...
        i.onload = function() {
            ...
            null != n && (n = n.getContext("2d"), n.clearRect(0, 0, 320, 240), n.drawImage(i, 0, 0, 320, 240)), e.width = i.width, e.height = i.height, t.drawImage(i, 0, 0), qrcode.width = i.width, qrcode.height = i.height;
            try {
        ...
        if (qrcode.debug) {
            for (var i = 0; i < qrcode.height; i++)
                for (var r = 0; r < qrcode.width; r++) {
                    ...
                    qrcode.imagedata.data[o] = 0, qrcode.imagedata.data[o + 1] = 0, qrcode.imagedata.data[o + 2] = n[r + i * qrcode.width] ? 255 : 0
                }
            e.putImageData(qrcode.imagedata, 0, 0)
        }
        for (n = new Detector(n).detect(), qrcode.debug && e.putImageData(qrcode.imagedata, 0, 0), n = Decoder.decode(n.bits).DataByte, e = "", i = 0; i < n.length; i++)
            for (r = 0; r < n[i].length; r++) e += String.fromCharCode(n[i][r]);
        return t = (new Date).getTime() - t, console.log(t), qrcode.decode_utf8(e)
    },
    getPixel: function(e, t) {
        if (qrcode.width < e) throw "point error";
        if (qrcode.height < t) throw "point error";
        return point = 4 * e + 4 * t * qrcode.width, p = (33 * qrcode.imagedata.data[point] + 34 * qrcode.imagedata.data[point + 1] + 33 * qrcode.imagedata.data[point + 2]) / 100
    },
    binarize: function(e) {
        for (var t = Array(qrcode.width * qrcode.height), n = 0; n < qrcode.height; n++)
    ...
    getMiddleBrightnessPerArea: function(e) {
        for (var t = Math.floor(qrcode.width / 4), n = Math.floor(qrcode.height / 4), i = Array(4), r = 0; 4 > r; r++) {
            i[r] = Array(4);
            ...
            for (o = 0; 4 > o; o++) {
                ...
                for (var s = 0; n > s; s++)
                    for (var a = 0; t > a; a++) {
                        ...
                        h < i[o][r][0] && (i[o][r][0] = h), h > i[o][r][1] && (i[o][r][1] = h)
                    }
            }
        for (e = Array(4), t = 0; 4 > t; t++) e[t] = Array(4);
        for (r = 0; 4 > r; r++)
            for (o = 0; 4 > o; o++) e[o][r] = Math.floor((i[o][r][0] + i[o][r][1]) / 2);
        return e
    },
    grayScaleToBitmap: function(e) {
        for (var t = qrcode.getMiddleBrightnessPerArea(e), n = t.length, i = Math.floor(qrcode.width / n), r = Math.floor(qrcode.height / n), o = Array(qrcode.height * qrcode.width), s = 0; n > s; s++)
            for (var a = 0; n > a; a++)
                for (var h = 0; r > h; h++)
                    for (var c = 0; i > c; c++) o[i * a + c + (r * s + h) * qrcode.width] = e[i * a + c + (r * s + h) * qrcode.width] < t[a][s] ? !0 : !1;
        return o
    },
    grayscale: function() {
        for (var e = Array(qrcode.width * qrcode.height), t = 0; t < qrcode.height; t++)
...
qrcode.orderBestPatterns = function(e) {
    ...
    var n = t(e[0], e[1]),
        i = t(e[1], e[2]),
        r = t(e[0], e[2]);
    i >= n && i >= r ? (i = e[0], n = e[1], r = e[2]) : r >= i && r >= n ? (i = e[1], n = e[0], r = e[2]) : (i = e[2], n = e[0], r = e[1]);
    var o = i.x,
        s = i.y;
    0 > (r.x - o) * (n.y - s) - (r.y - s) * (n.x - o) && (o = n, n = r, r = o), e[0] = n, e[1] = i, e[2] = r
};